...
public class SignUpDao extends TangoTabBaseDao
{
	 ...
	 */
	public String signUp(UserVo userVo) throws TangoTabException
	{
		...
		{	
			...
			throw new TangoTabException("SignUpDao", "signUp", e);
		}
		catch (SAXException e)
		{
			Log.e("Exception :", "SAXException occured in Sign up service respone ", e);
			throw new TangoTabException("SignUpDao", "signUp", e);
		}		
		return message;
	}
