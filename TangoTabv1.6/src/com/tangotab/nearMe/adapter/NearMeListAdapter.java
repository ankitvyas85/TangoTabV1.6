...
public class NearMeListAdapter extends BaseAdapter 
{
	...
	/**
	 * OverLoaded Constructor for NearMeListAdapter.
	 * @param context
	 * @param dealsDetailList
	 * @param locationSearch
	 */
	public NearMeListAdapter(Context context,List<DealsDetailVo> dealsDetailList,LinearLayout llShowMore) 
	{
	...
	public View getView(final int position, View convertView, ViewGroup viewGroup) 
		{
			...
			//int numDigits= noOfDigits(dealsDetailVo.getNoDealsAvailable());
//			if(numDigits>1)
//			{
				...
				nodealsavailable.setText(dealsAvailable);
//			}
//			else
//			{
//				nodealsavailable.setText(dealsDetailVo.getNoDealsAvailable()+ " offers available" + " " + drivingDistance + " miles");
//			}
	...
	/**
	 * Find the number of Digits in number of deals available.
	 * 
	 * @param number
	 * @return
	 */
	/*private int noOfDigits(String noOfDeals)
	{
		if(ValidationUtil.isNullOrEmpty(noOfDeals))
			return 0;
		int number = Integer.parseInt(noOfDeals);
		int digitCount=0;
		while(number!=0)
		{
			digitCount++;
