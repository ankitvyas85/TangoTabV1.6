...
/**
 * This class will be used to parse the response XML and store into uservo list
 * 
 * @author dillip.lenka
 *
 */
...
public class UserValidationXmlHandler extends DefaultHandler 
{
	...
	boolean in_message,in_user_details, in_first_name, in_last_name, in_zip_code,in_userId,
			in_mobile_phone = false;
	public String user_Id,first_name, last_name, zip_code, mobile_phone = "";
	...
	public void endElement(String uri, String localName, String qName)throws SAXException
	{
		...
		{
			in_mobile_phone = false;
			UserVo userVo = new UserVo(first_name, last_name, zip_code, mobile_phone,user_Id,null,null,null);
